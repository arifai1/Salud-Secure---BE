...
$("#divt").hide();//# hago referencia al id. .Hago referencia a la clase de ese objeto.
    $("#E").mouseover(function(){             //hago referencia a la clase boton.
        ...
        if($("#u").val()=='' && $("#p").val()==''){
        	...
        	$("#divt").html("Debe agregar credencial y fecha de nacimiento");
        	$("#divt").show();
        }else if($("#c").val()=='' && $("#f").val()!=""){
        	$("#divt").html("Debe agregar credencial");
        	$("#divt").show();
        }else if($("#c").val()!='' && $("#f").val()==""){
        	$("#divt").html("Debe agregar fecha de nacimiento");
        	$("#divt").show();
        }
    });
...
$("#R").click(function(){
        ...
        dataType: "json",               
        data: 'usu=' + $("#u").val() + '&pass=' + $("#p").val() + '&nom='+$("#n").val()+'&ape='+$("#a").val()+'&dni='+$("#d").val()+'&credencial='+$("#c").val()+'&nac='+$("#f").val(), 
